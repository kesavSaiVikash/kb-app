  ...
  return (
    <section className="relative w-full h-screen mx-auto">
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            ...
            <span className="animate-text bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent font-black">
              Kesav <span className="hidden sm:inline">Bollam</span>
            </span>
          </h1>
      ...
      <div className="absolute right-5 top-1/2 -translate-y-1/2 flex flex-col gap-5 items-center md:mt-10 mt-5 md:gap-12">
        <Link
          target="_blank"
          to="https://www.linkedin.com/in/kesavsaivikashbollam/"
        >
          <BsLinkedin
            size={30}
        ...
        <Link target="_blank" to="https://github.com/kesavsaivikashbollam">
          <BsGithub
            size={30}
        ...
        <Link target="_blank" to="https://twitter.com/kesavbollam">
          <BsTwitter
            size={30}
        ...
        <Link target="_blank" to="https://discord.com/channels/@kesavbollam">
          <BsDiscord
            size={30}
        ...
        <Link target="_blank" to="https://www.instagram.com/kbtek.inc/">
          <BsInstagram
            size={30}
            className="icon hover:text-[#E1306C] hover:translate-y-[-2px] hover:cursor-pointer transition-all ease-in duration-100"
          />
        </Link>
        <Link target="_blank" to="https://www.facebook.com/bksvikash123">
          <BsFacebook
            size={30}
